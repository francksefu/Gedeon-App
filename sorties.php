            ...
            <div class="row bg-transparent pt-5">
                <div class="col-md-6 bg-transparent m-2">
                    ...
                    <p class=" text-secondary pt-3">
                        ...
                        il peut s agir d une sortie due a une certaine charge(paie du loyé, paie de la facture de l ectricité, emprunt a un voisin, payer un employé,...)
                    </p>
                </div>
