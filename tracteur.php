        ...
        <div class="container bg-transparent pt-5" >
            <div class="row bg-transparent pt-5">
                <div class="col-md-6 bg-transparent m-2">
                    <h2>Lister les besoins des tracteurs</h2>
                    <p class=" text-secondary pt-3">
                        Un tableau de bord tracteurs vous permet d entrer les informations concernant vos tracteurs comme les couts des mazouts
                        , les cout des pannes et tout autre informations sur le tracteur, faisant allusion a une certaine entrer ou a une certaine 
                        ou a une certaine sortie.
                    </p>
                </div>
