            ...
            <div class="row bg-transparent pt-5">
                <div class="col-md-6 bg-transparent m-2">
                    ...
                    <p class=" text-secondary pt-3">
                        Un tableau de bord vous donne un aperçu de la liste des utilisateurs avec accès aux données les plus importantes,
                ...
                <div class="col-md-3 bg-transparent pt-5">
                    <p class="text-center">
                        <a href="addVentes.html" class="btn btn-primary p-2">&plus; Ajoutez utilisateur</a>
                    </p>
                </div>
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="input-group mb-3 w-75">
                        ...
                        <label class="input-group-text" for="inputGroupSelect01">utilisateurs</label>
                      </div>
                </div>
