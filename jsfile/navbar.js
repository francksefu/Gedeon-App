  ...
  <div class="collapse navbar-collapse" id="mynavbar">
    <ul class="navbar-nav me-auto">
      ...
      <li class="nav-item pe-3 dropdown" >
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="customers.php">Clients</a></li>
            <li><a class="dropdown-item" href="addCustomers.php">Ajoutez clients</a></li>
            <li><a class="dropdown-item" href="users.php">Utilisateurs</a></li>
            <li><a class="dropdown-item" href="addUsers.php">Ajoutez utilisateurs</a></li>
          </ul>
      </li>
      ...
      <li class="nav-item pe-3 dropdown" >
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="sorties.php">Listez les sorties</a></li>
            <li><a class="dropdown-item" href="addSorties.php">Ajoutez sortie</a></li>
          </ul>
      </li>
