        ...
        <div class="container bg-transparent pt-5" >
            <div class="row bg-transparent pt-5">
                <div class="col-md-6 bg-transparent m-2">
                    <h2>choses dans votre depot</h2>
                    <p class=" text-secondary pt-3">
                        C est votre depot, la ou vous mettez vos materiaux pour plus tard, entrez y alors...
                        Notez juste que lorsque vous sortez quelque chose dans le depot, veuillez juste modifier le ?Commentaire
                        en y mettant la date de sortie du depot et la quantité
                    </p>
                </div>
                
                <div class="col-md-3 bg-transparent pt-5">
                    <p class="text-center">
                        <a href="addDepot.php" class="btn btn-primary p-2">&plus; Ajoutez du materiel dans l depot</a>
                    </p>
                </div>
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="input-group mb-3 w-75">
                        ...
                        <label class="input-group-text" for="inputGroupSelect01">entrer</label>
                      </div>
                </div>
            ...
            <div class="input-group mt-3 col-md-10 montre-moi">
                ...
                <input type="hidden" value="depot" id="type" >
        </div>
                    ...
                    <td >
                        <div class="d-flex flex-row justify-content-center">
                            ...
                            <div class="p-2 bg-primary m-2 text-white rounded-3">
                                <a href="updateDepot.php" class="text-white">
