    ...
    <main>
        <div class="container bg-transparent pt-5" >
            <div class="row bg-transparent pt-5">
                <div class="col-md-6 bg-transparent m-2">
                    ...
                    <p class=" text-secondary pt-3">
                        Ici vous definissez le salaire que vous devez donnez a vos employé quand vous obtenez 
                        un travail ( cop ou champs a labourer ). pour le reste je m en occuperai pour vous, definissez et moi je calcule
                    </p>
                </div>
                
                <div class="col-md-3 bg-transparent pt-5">
                    <p class="text-center">
                        <a href="addSalaire.php" class="btn btn-primary p-2">&plus; Add salaire</a>
                    </p>
                </div>
            ...
            <div class="input-group mt-3 col-md-10 montre-moi">
                ...
                <input type="hidden" value="salaire" id="type" >
        </div>
                    ...
                    <td >
                        <div class="d-flex flex-row justify-content-center">
                            ...
                            <div class="p-2 bg-primary m-2 text-white rounded-3">
                                <a href="updateSalaire.php" class="text-white">
