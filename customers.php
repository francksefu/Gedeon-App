        ...
        <div class="container bg-transparent pt-5" >
            <div class="row bg-transparent pt-5">
                <div class="col-md-6 bg-transparent m-2">
                    ...
                    <p class=" text-secondary pt-3">
                        Un tableau de bord client vous permet de collecter et de visualiser
                        facilement les données client a partie de l'optimisation de l'experience
                        client assurant la fidelisation de clientèle
                    </p>
                </div>
                
                <div class="col-md-3 bg-transparent pt-5">
                    <p class="text-center">
                        <a href="addVentes.html" class="btn btn-primary p-2">&plus; Add client</a>
                    </p>
                </div>
            ...
            <div class="row">
                ...
                <div class="input-group w-50 col-md-5">
                    ...
                    <input type="text" class="form-control" placeholder="Entrer un detail dont vous vous rappeler sur le client">
                </div>
            </div>
        </div>
