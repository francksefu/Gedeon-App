...
<body class="bg-light">
    ...
    <main>
        <div class="container bg-transparent pt-5" >
            <div class="row bg-transparent pt-5">
                <div class="col-md-6 bg-transparent m-2">
                    <h2>Liste l historique</h2>
                    <p class=" text-secondary pt-3">
                        C est ici que vous ecrivez une sorte de conclusion de votre busness, ou ce que vous envisagez faire dans le futur
                        Vous pouvez ecrire un truc genre, c est mois je n ai pas fait une rentrée d argent comme je l esperai, tiens il etait de 1000fr,
                        le mois prochain je dois double cela ... c est juste un exemple mais ecrivez quand meme ce que vous voulez
                    </p>
                </div>
                
                <div class="col-md-3 bg-transparent pt-5">
                    <p class="text-center">
                        <a href="" class="btn btn-primary p-2">&plus; Add historique</a>
                    </p>
                </div>
        ...
        <?php
                ...
                $reqSql= ("SELECT * FROM Historique order by idHistorique desc");
