...
<body class="bg-light">
    ...
    <main>
        <div class="container bg-transparent pt-5" >
            <div class="row bg-transparent pt-5">
                <div class="col-md-6 bg-transparent m-2">
                    <h2>Liste des clients pour champs, tours ou contrats</h2>
                    <p class=" text-secondary pt-3">
                        Cette section repertories les travaux que vous faites pour les clients qui peuvent etre des champs,
                        des tours, ou des contrats
                    </p>
                </div>
            ...
            <div class="input-group mt-3 col-md-10 montre-moi">
                ...
                <input type="hidden" value="champs" id="type" >
        </div>
        ...
        <?php
                ...
                $reqSql= ("SELECT * FROM Champs_cultive order by idChamps desc");
                    ...
                    <td >
                        <div class="d-flex flex-row justify-content-center">
                            ...
                            <div class="p-2 bg-primary m-2 text-white rounded-3">
                                <a href="updateChamps.php" class="text-white">
