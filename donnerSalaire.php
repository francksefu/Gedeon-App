        ...
        <div class="container bg-transparent pt-5" >
            <div class="row bg-transparent pt-5">
                <div class="col-md-6 bg-transparent m-2">
                    <h2>Lister les payements des salaires</h2>
                    <p class=" text-secondary pt-3">
                        Dans cette section vous pouvez voir avec les detailles comment vous avez payé
                        par tranche ou totalement vos travailleurs
                    </p>
                </div>
            ...
            <div class="input-group mt-3 col-md-10 montre-moi">
                ...
                <input type="hidden" value="paiement" id="type" >
        </div>
                    ...
                    <td >
                        <div class="d-flex flex-row justify-content-center">
                            ...
                            <div class="p-2 bg-primary m-2 text-white rounded-3">
                                <a href="updatePaiement.php" class="text-white">
