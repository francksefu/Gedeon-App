        ...
        <div class="container bg-transparent pt-5" >
            <div class="row bg-transparent pt-5">
                <div class="col-md-6 bg-transparent m-2">
                    <h2>Liste d entrer dans la caisse</h2>
                    <p class=" text-secondary pt-3">
                        Cette section d entrer vous renseigne sur les entrers dans votre caisse d argent,
                        il peut s agir d une entrer due a un paiements apres un certain travail, paiements d argent que vous avez emprunté,...
                    </p>
                </div>
            ...
            <div class="row">
                ...
                <div class="input-group w-50 col-md-5">
                    ...
                    <input type="text" id="input" class="form-control search" placeholder="Entrer un detail dont vous vous sur un utilisateur">
                </div>
            </div>
